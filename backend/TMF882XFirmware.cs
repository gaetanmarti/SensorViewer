// TMF882X Firmware Image
// This file contains the firmware blob required for the TMF882X Time-of-Flight sensor initialization.
//
// Firmware sources:
...
//
// This firmware is provided by ams OSRAM and is required to initialize the sensor from bootloader mode.

namespace immensive;

/// <summary>
/// TMF882X Firmware Data
/// This class contains the firmware image that is downloaded to the TMF882X sensor during initialization.
/// </summary>
public static class TMF882XFirmware
{
    /// <summary>
    /// TMF882X firmware blob
    /// This firmware is downloaded to the sensor in chunks during initialization.
    /// Retrieved from: 'tmf882x_image.*' in archive 'TMF8828_Driver_Arduino_Source_v14.zip'
    /// </summary>
    ...
    /// <summary>
    /// Start address where the firmware should be loaded
    /// </summary>
    public const ushort StartAddress = 0x0000;

    /// <summary>
    /// Size of each chunk when downloading firmware to the sensor
    /// </summary>
    public const byte ChunkSize = 128;

    /// <summary>
    /// Download initialization parameter
    /// </summary>
    public const byte DownloadInitParam = 0x29;
}
